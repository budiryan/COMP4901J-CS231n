...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dx_affine_2, grads['W3'], grads['b3'] = affine_backward(dout, cache_affine2)
        dx_affine_1, grads['W2'], grads['b2'] = affine_relu_backward(dx_affine_2, cache_affine1)
        dx_conv, grads['W1'], grads['b1'] = conv_relu_pool_backward(dx_affine_1, cache_conv)
